...
replace region = 14 if group20==1 // Latin America

lab de region  1 "United States" 2 "Rest of North America" 3 "Brazil" 4 "Rest of Latin America" 5 "Germany" 6 "Rest of European Union" 7 "United Kingdom" 8 "Rest of Europe" 9 "MENA" 10 "Sub-Saharan Africa" 11 "India" 12 "Rest of South Asia" 13 "East Asia and Pacific" 14 "Latin America"
...
xtline new_cases_ma7 if region==14, overlay xtitle("") ytitle("New cases (7 day M-A)") 
graph export ./figures/region_cases_Latin America.png, replace wid(1000)
